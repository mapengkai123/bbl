...
<div id="box"> 
	<h2 align="center">发单评论</h2> 
		...
		{% for val in data %}
		<span><h2>总星</h2></span> 
		<span><small>{{val.e_level}}</small></span> 
			<div>
			<br>
		{% endfor%}
				<em>(一般)</em>
		...
		<div id="doPoint"> 
			...
			{% for val in data %}
			<li>
				<ul>服务:<img src="../public/statics/star{{val.e_fuwu}}.gif" alt=""></ul>   
				<ul>速度:<img src="../public/statics/star{{val.e_speed}}.gif" alt=""></ul>
				<ul>信用:<img src="../public/statics/star{{val.e_info}}.gif" alt=""></ul>
			</li>
			{% endfor%}
			</table>
