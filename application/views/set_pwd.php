...
<body>
	...
	<div data-role="page" class="touzi phone" id="phone">
		...
		<div class="ui-content" data-role="content">
            <form  method="post" action="{{host}}set/set_topwd"  data-ajax="false" >
				<ul>
                    <li>
                        <label>手机号：</label>
                    ...
                    <li>
                        <label>旧的登陆密码：</label>
                        <input type="password" name="jpwd" id="jpwd" required=""  placeholder="请输入旧密码" maxlength="10" data-role="none"/>
                    </li>
                    <li>
                        <label>新的登陆密码：</label>
                        <input type="password" name="pwd" id="pwd" required=""  placeholder="请填6-10数字密码" maxlength="10" data-role="none"/>
                    </li>
                    <li>
                        <label>确认密码：</label>
   		...
   		<script type="text/javascript">
   			$(window).load(function(){
                ...
                $("#jpwd").blur(function(){
                    ...
                    $.post("{{host}}set/old",{pwd:jps},function(ps){
                        //alert(ps);
                        if(ps!=1){
                            zhe.style.border="1px solid red";
                            return false;
